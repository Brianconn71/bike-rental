...
class BikeRentalTest(unittest.TestCase):
    ...
    def test_returnBike_for_invalid_numOfBikes(self):
        ...
        # create valid rentalTime and rental basis
        customer.rentalTime = datetime.now()
    ...
    def test_returnBike_for_valid_credentials(self):
        ...
        self.assertEqual(shop.returnBike(request1), 14)
        self.assertEqual(shop.returnBike(request2), 402.5)
        self.assertEqual(shop.returnBike(request3), 112)
        self.assertEqual(shop.returnBike(request4), 1456)
        self.assertEqual(shop.returnBike(request5), 8820)
        self.assertEqual(shop.returnBike(request6), 35280)
